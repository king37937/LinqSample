    ...
    internal class RepositoryFactory
    {
        ...
        public static IEnumerable<T> GetProducts()
        {
            return new List<T>
            {
                ...
                new T{Id=5, Cost=51, Price=510, Supplier="Momo" },
                new T{Id=6, Cost=61, Price=610, Supplier="Momo" },
                new T{Id=7, Cost=71, Price=710, Supplier="Yahoo" },
                new T{Id=8, Cost=18, Price=780, Supplier="Yahoo" },
            };
        }
